...
record('BuildConfig shell versionName 1.0.123', /versionName\s*=\s*"1\.0\.123"/.test(gradle));
record('BuildConfig shell versionCode 124', /versionCode\s*=\s*124/.test(gradle));
