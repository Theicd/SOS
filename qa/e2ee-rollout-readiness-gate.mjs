...
// Encrypted send off
record('LIVE encrypted send absent in chat-service', !svc.includes('encryptPrivateChatPayload'));
record('encrypt helper exists but QA-isolated in chat-e2ee', e2ee.includes('encryptPrivateChatPayload'));
