...
// SW
record('SW CACHE_NAME sos-cache-v846', /sos-cache-v846/.test(sw));
...
// RC: secure-wake115; minSecureChatEpoch=2; e2eeSendRequired true; mediaServerE2eeRequired true; callSignalGiftWrapRequired true
record('app-version secure-wake115', String(appVer.version || '').includes('secure-wake115'));
