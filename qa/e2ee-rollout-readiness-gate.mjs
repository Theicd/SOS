...
// SW
record('SW CACHE_NAME sos-cache-v845', /sos-cache-v845/.test(sw));
...
// RC: call-giftwrap-final1; minSecureChatEpoch=2; e2eeSendRequired true; mediaServerE2eeRequired true; callSignalGiftWrapRequired true
record('app-version call-giftwrap-final1', String(appVer.version || '').includes('call-giftwrap-final1'));
