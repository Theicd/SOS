...
record('production web version call-session-terminal1',
  String(appVer.version || '').includes('call-session-terminal1'));
...
record('SW cache v847', /sos-cache-v847/.test(read('service-worker.js')));
record('public APK frozen 1.0.115',
