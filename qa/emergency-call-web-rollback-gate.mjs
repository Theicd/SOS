...
record('I SW sos-cache-v866',
  /sos-cache-v866/.test(sw));
record('I web version call-drain1 or later',
...
record('I call script cache-busters present',
  /call-signal-e2ee\.js\?v=20260920drain1/.test(videos)
  && /chat-voice-call\.js\?v=20260920drain1/.test(videos)
