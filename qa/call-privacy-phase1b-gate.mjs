...
record('voice still gift-wrap send', voice.includes('publishGiftWrappedCallSignal'));
record('video still gift-wrap send', video.includes('publishGiftWrappedCallSignal'));
